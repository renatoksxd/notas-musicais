<img src="https://notas-musicais-readthedocs.readthedocs.io/pt-br/latest/assets/logo%20notas%20musicais.png" width="200">
...
[![CI](https://github.com/renatoksxd/notas-musicais/actions/workflows/pipeline.yaml/badge.svg)](https://github.com/renatoksxd/notas-musicais/actions/workflows/pipeline.yaml)
[![codecov](https://codecov.io/gh/renatoksxd/notas-musicais/branch/main/graph/badge.svg?token=OVQQF4IQY2)](https://codecov.io/gh/renatoksxd/notas-musicais)
...
Você pode chamar os campos harmônicos via subcomando `campo-harmonico`. Por exemplo:
...
╭─ Arguments ──────────────────────────────────────────────────────────────────────────────────────────╮
│   tonica          <str>  Tônica do campo harmônico [default: c]                                      │
│   tonalidade      <str>  Tonalidade do campo harmônico [default: maior]                              │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────╯
╭─ Options ────────────────────────────────────────────────────────────────────────────────────────────╮
