...
O modulo de acordes conta com funções e ferramentas necessárias para a geração de acordes.
"""
...
def semitom(nota: str, intervalo: int):
    # fmt: off
    """
...
def triade(nota: str, tonalidade: str):
    # fmt: off
    """
